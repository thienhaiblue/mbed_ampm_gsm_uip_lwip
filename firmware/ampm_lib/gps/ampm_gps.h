...
typedef struct {
	uint8_t gpsCalcCheckSumFlag;
	uint8_t gpsCheckSum;
	uint8_t gpsCheckSumX;
	uint8_t gpsGetCheckSumFlag;
	uint8_t GPRMC_gotDataFlag;
	uint8_t GPGGA_gotDataFlag;
	uint8_t GPGSA_gotDataFlag;
	uint8_t GPGSV_gotDataFlag;
	char buffGPRMC[GPS_MSG_MAX_SIZE];
	char buffGPGGA[GPS_MSG_MAX_SIZE];
	char buffGPGSA[GPS_MSG_MAX_SIZE];
	char buffGPGSV[GPS_MSG_MAX_SIZE];
