...
#define	CS_SET	SDCard::ChipSelectSet
#define FCLK_FAST SDCard::SPI_SetHighFreq
#define FCLK_SLOW SDCard::SPI_SetLowFreq
#define xchg_spi(x)					SDCard::SPI_WriteByte
...
{	
	...
	if (MMC_disk_ioctl(0, GET_SECTOR_COUNT, (BYTE *)&disk_sector_number_max) == RES_OK)
	{
	...
	if (MMC_disk_ioctl(0, GET_SECTOR_SIZE, (BYTE *)&disk_sector_size) == RES_OK)
	{
